...
- Apple Silicon and Intel macOS `qd` binaries MUST be built by `.github/workflows/release.yml` on a macOS runner; do not attempt to publish them from the Linux release host.
