...
## Summary
- 1280 nodes · 2819 edges · 81 communities (58 shown, 23 thin omitted)
...
Cohesion: 0.12
Nodes (24): root, ClientTextMetricErrorCategory, recordTextMetric(), RoomController, RoomKind, TextDrop, TextDropContentType, dropContentTypeLabel() (+16 more)

### Community 5 - "text-session-service.test.ts"
Cohesion: 0.13
Nodes (15): ClearTextDropsResult, CreateTextDropInput, DeleteTextDropResult, TextDropsRepository, UpdateTextDropInput, UpdateTextDropResult, expectJoined(), MutableClock (+7 more)

### Community 6 - "storage-quota.ts"
Cohesion: 0.22
Nodes (12): generateShortId(), uploads, hasPostgresUniqueViolation(), registerUploadWithStorageReservation(), ReserveUploadStorageResult, StorageReservation, StorageReservationExpiredError, findActiveByShortId() (+4 more)
...
Cohesion: 0.11
Nodes (38): DesktopUpdatePlatform, escapeRegExp(), handleDesktopUpdateDownload(), handleDesktopUpdateManifestDownload(), isDesktopUpdatePlatform(), PLATFORM_ASSET_NAMES, handleReleaseAssetDownload(), buildApp() (+30 more)
...
Cohesion: 0.17
Nodes (29): ClientTextMetric, connectRoom(), createJsonRequest(), createRoom(), fetchSnapshot(), formatIdleWindow(), formatRemaining(), formatRoomExpiry() (+21 more)
...
Cohesion: 0.20
Nodes (18): Database, db, SqlClient, textRooms, clearDrops(), createDrop(), CreateTextDropResult, deleteDrop() (+10 more)
...
### Community 70 - "github-release.ts"
Cohesion: 0.32
...
- **Should `TextSession.tsx` be split into smaller, more focused modules?**
